...
def get_args_parser():
    ...
    parser.add_argument('--batch_size', default=16, help='the number of batch_size', type=int)

    return parser

def main(args, train_images_path, train_images_label, val_images_path, val_images_label, dataset_name):
    # torch.manual_seed(42)
    # torch.cuda.manual_seed(42)
    # torch.cuda.manual_seed_all(42)
    # np.random.seed(42)
    model_name = dir_name = 'AMILv4' + args.number
    warmup_epochs = 10
    yhq = 'ms'
    opt = 'AdamW'
    model = MIL()
...
if __name__ == '__main__':
    ...
    model, dir_name = main(args, train_images_path, train_images_label, val_images_path, val_images_label, dataset_name)
    train_images_path, train_images_label, val_images_path, val_images_label = dataSplit.read_split_data(
